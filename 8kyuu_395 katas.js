...
String.prototype.toAlternatingCase = function() {
  return [...this].map(c => char[`to${c > 'Z' ? 'Uppe' : 'Lowe'}rCase`]()).join``;}
...
bw=(b,e)=> b<e? [b, ...bt(b+1,e)]:[a]; //iterator function
...
let calculateTip = (a, r) => (i = ['terrible', 'poor', 'good', 'great', 'excellent'].indexOf(r.toLowerCase()),
	i < 0 ? "Rating not recognised" : Math.ceil(i*.05 * a))
...
//padStart(fill with this, until length get to this)
